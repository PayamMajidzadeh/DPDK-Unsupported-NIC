#!/bin/bash
      ...
      apt-get update
     	apt-get install build-essential automake docker.io linux-headers-$(uname -a | awk '{print $3}') vim kmod python python-pip libtool gcc-multilib libnuma-dev pkg-config libpcap-dev #lua5.3 liblua5.3-dev libpcap0.8-dev clang python3.4 python-pyftpdlib libssl-dev
